...
#' @param BV Matrix of breeding values of genotypes for all traits
#' @param ncomb Number of Characters/Traits group
#' @param matp Phenotypic Variance-Covariance Matrix
#' @param matg Genotypic Variance-Covariance Matrix
#' @param wmat Weight Matrix
#' @param wcol Weight column number in case more than one weights, by default its 1
#' @param GA Genetic Advance of comparative Character/Trait i.e. Yield (Optional argument)
#' @param wg Subset of Genotypic Variance-Covariance Matrix
#' @param d Vector of desired gains of traits
#' @param h2 Heritability of the trait of interest
